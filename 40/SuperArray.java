/*
  Team Pen-Grin -- Dorothy Ng, Janet Zhang
  APCS1 pd5
...
public class SuperArray {
	...
	if(newVal==0){set(_lastPos+1,-1);} //doesn't allow user to add 0 to the array, and lets you know it was invalid with -1
	else{set(_lastPos+1,newVal);} //or just do the regular thing
	_size++;
	_lastPos++;
    }
